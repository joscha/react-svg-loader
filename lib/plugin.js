...
exports.default = function (babel) {
  ...
  var getExport = function getExport(svg) {
    var className = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'SVG';

    return t.exportDefaultDeclaration(t.classDeclaration(t.identifier(className), t.memberExpression(t.identifier('React'), t.identifier('Component<any, undefined>')), t.classBody([t.classMethod('method', t.identifier('render'), [], t.blockStatement([t.returnStatement(svg)]))]), []));
  };
  ...
  var programVisitor = {
    Program: function Program(path) {
      ...
      path.node.body.unshift(t.importDeclaration([t.importDefaultSpecifier(t.identifier('* as React'))], t.stringLiteral('react')));
    }
  };
